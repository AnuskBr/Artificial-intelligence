# -*- coding: utf-8 -*-
"""
Created on Thu Apr  4 14:06:24 2024
...
for train_index, test_index in kf.split(X):
    ...
    svm1 = SVC(kernel='rbf', C=0.4, gamma='auto',random_state=1,probability=False)
...
print('Acuratetea medie a modelului SVM: {:.2f}'.format(avg_accuracy))
